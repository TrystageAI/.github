...
**AI tools, knowledge bases, and server utilities for Trystage.**
...
- **Knowledge bases** — structured, searchable context for AI assistants.
- **Server tooling** — practical plugins and utilities for staff workflows.
- **Assistant engineering** — prompts, roles, and behavior for Trystage AI cats.
- **Operations** — notes, tooling, and automation around Trystage services.

<div align="center">

<sub>Practical AI tooling, with a bit of cat energy.</sub>
